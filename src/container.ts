import { formatErrorCtor, isTokenDescriptor, isTransformDescriptor } from './adapter'
import { DelayedConstructor } from './helpers'
import { isClassProvider, isConstructorToken, isFactoryProvider, isNormalToken, isProvider, isTokenProvider, isValueProvider, Provider } from './provider'
import { ClassProvider, constructor, DependencyContainer, Disposable, FactoryProvider, InjectionToken, InterceptorOptions, isDisposable, Lifecycle, ParamInfo, PostResolutionInterceptorCallback, PreResolutionInterceptorCallback, RegistrationOptions, ResolutionType, TokenProvider, typeInfo, ValueProvider } from './types'
...
class InternalDependencyContainer implements DependencyContainer
{
    ...
    ): InternalDependencyContainer
    {
        ...
        )
        {
            ...
            {
                throw new Error(
                    `Cannot use lifecycle "${Lifecycle[options.lifecycle]
